...
SAEM.sclm = function(y, x, ci, lcl=NULL, ucl=NULL, coords, init.phi, init.nugget, type="exponential", kappa=NULL,
                     lower=c(0.01,0.01), upper=c(30,30), MaxIter=300, M=20, pc=0.25, error=1e-5, show.SE=TRUE){
  n = length(c(y))
  ...
  out.Sp = SAEM_Spatial(y, x, ci, lcl, ucl, coords, init.phi, init.nugget, type,
