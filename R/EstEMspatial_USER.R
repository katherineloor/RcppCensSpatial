...
EM.sclm = function(y, x, ci, lcl=NULL, ucl=NULL, coords, init.phi, init.nugget, type="exponential", kappa=NULL,
  ...
  out.Sp = EM_Spatial(y, x, ci, lcl, ucl, coords, init.phi, init.nugget,
